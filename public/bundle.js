...
/* harmony import */ var _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./presenter/movie-list.js */ "./src/presenter/movie-list.js");
/* harmony import */ var _presenter_filter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./presenter/filter.js */ "./src/presenter/filter.js");
...
moviesModel.setFilms(_mock_films_js__WEBPACK_IMPORTED_MODULE_6__["randomFilms"]);
...
const filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_9__["default"](siteMain, filterModel, moviesModel);
const movieList = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_8__["default"](siteMain, moviesModel, filterModel);
...
if (_mock_films_js__WEBPACK_IMPORTED_MODULE_6__["QANTITY_FILMS"] === 0) {
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(footerStatistics, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_3__["default"](_variables_js__WEBPACK_IMPORTED_MODULE_0__["QuantityFilms"].ALL_FILMS));
}
  ...
  for (let i = 0; i < QANTITY_FILMS; i++) {
    films[i] = {
      ...
      filmInfo: {
        ...
        totalRating: Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["getRandomNumber"])(0, 10, 1),
        ageRating: `16+`,
...
class Filter {
  ...
  init() {
    ...
    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._filterComponent);
      return;
    }
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFilter(_variables_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR, filterType);
  ...
  _countFilters() {
    return {
      watchlist: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"].WATCHLIST(this._moviesModel.getFilms()).length,
      favorites: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"].FAVORITES(this._moviesModel.getFilms()).length,
      history: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"].HISTORY(this._moviesModel.getFilms()).length,
    };
  }
}
...
class MovieList {
  constructor(container, moviesModel, filterModel) {
    ...
    this._quantityAllFilms = _mock_films_js__WEBPACK_IMPORTED_MODULE_5__["QANTITY_FILMS"];
...
/*!**************************!*\
  !*** ./src/variables.js ***!
  \**************************/
/*! exports provided: QuantityFilms, SortType, EmojiType, UpdateType, UserAction, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
